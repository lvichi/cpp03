...
int	main(void) {
    ...
    std::cout << "--Things got confused--" << std::endl;

    DiamondTrap    straycat("StrayCat");
    straycat.whoAmI();
    straycat.attack("ThorCat");
    thorcat.takeDamage(30);
    straycat.attack("OdinCat");
    odincat.takeDamage(30);
    straycat.attack("ThorCat");
    thorcat.takeDamage(30);
    straycat.attack("OdinCat");
    odincat.takeDamage(30);
